...
- Latest release: v0.22.0 (2026-07-23, minor) — heartbeat-step-output-vars (GH #42, feat), heartbeat-destination-actoryaml (GH #41, fix). Prior: v0.21.0 (minor) jarvis-syspilot + notification improvements.
