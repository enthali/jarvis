...
- Latest release: v0.27.2 (2026-09-19, patch) — whoami-hookless-error (fix: honest error when hooks disabled) + focus-restore-toggle (feature: configurable focus restore after delivery, new setting jarvis.messaging.restoreFocusAfterDelivery). Prior: v0.27.1 (patch) whoami-all-entity-kinds.
