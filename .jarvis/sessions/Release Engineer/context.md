...
- Latest release: v0.20.1 (2026-07-19, patch) — touched-files-write-race (GH #35) + flow-message-pagination (GH #36). Prior: v0.20.0 (minor) actor-touched-files (GH #18); v0.19.0 (minor) message-log-viewer + actor-activity-indicator.
