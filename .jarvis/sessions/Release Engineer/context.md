...
- Latest release: v0.17.2 (2026-07-14, patch) — unified-entity-tree regression fix + bold category labels (GH #29). Prior: v0.17.1 (patch) agent-mode-persistence GH #25; v0.17.0 (minor) Consequent Actor Renaming.
...
- Infrastructure Changes pattern: direct-fix commits on develop with no CD still require a release-notes entry; no docs/changes archival step (nothing to archive). Version is still bumped and tagged as normal.
