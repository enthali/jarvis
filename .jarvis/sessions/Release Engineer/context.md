...
- Latest release: v0.18.0 (2026-07-16, minor) — actor-owned-files-tree (GH #15) + dynamic-tree-title. Prior: v0.17.3 (patch) flow-updater-fix; v0.17.x (patch series); v0.17.0 (minor).
