...
- Latest release: v0.15.2 (2026-07-03, patch) — entity-tree-context-menu, hook-log-level-reduction, ui-improvements, heartbeat-venv-autodetect, repo hygiene. Prior: v0.15.1 (patch) pim-treenode-filenode-fix; v0.15.0 (minor) editor-group-placement, entity-files-tree, entity-open-context-cleanup, entity-taxonomy-rename.
