...
| entity-taxonomy-rename | 2026-07-01 | L0 PASS (2 advisory) / L1 PASS / L2 PASS (1 medium: dual openContext/openSessionContext commands undisclosed; 1 low: residual "session" prose in SPEC_ENT_TREECLICK) | PASS (3 chains: US_ENT_ENTITY, US_ACT_ACTORS, SPEC_ENG_SCANNER) | n/a (spec-only, no code) | n/a | All 5 Round 1 findings resolved and independently re-verified (CD tables backfilled, disclosure line, prose fix, yamlScanner.ts comment, US_ENT_ENTITY downward links, US_PRJ_PROJECT/US_EVT_EVENT added). | QM FINAL SIGN-OFF — CLEAR |
