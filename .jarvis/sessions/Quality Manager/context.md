...
- Artefakt-Removal-Check (b) active-docs class often misses `docs/releasenotes.md` — release-notes hits should be classified (c) historic stranding, not omitted; re-grep this file in every removal-CR review
